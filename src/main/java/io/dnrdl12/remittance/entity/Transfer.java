...
public class Transfer extends BaseEntity {
    ...
    @Schema(description = "거래 요청일시 (DB default CURRENT_TIMESTAMP)")
    @Comment("거래 요청일시 (DB default CURRENT_TIMESTAMP)")
    @Column(
            name = "requested_date",
            insertable = false,
            updatable = false,
