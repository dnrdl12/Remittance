...
public class Ledger extends BaseEntity {
    ...
    @Comment("분개 시각 (DB default CURRENT_TIMESTAMP)")
    @Column(
            name = "entry_time",
            insertable = false,
            updatable = false,
